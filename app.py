...
app = Flask(__name__)
CORS(app)  # allow browser clients; tighten as needed (e.g., CORS(app, resources={r"/*": {"origins": "https://your-game-host"}}))  # NEW [ref]

# Use persistent disk path if provided
DB_FILE = os.environ.get("DB_PATH", "./leaderboard.json")
